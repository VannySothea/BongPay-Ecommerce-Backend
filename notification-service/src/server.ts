...
import {
	...
	handleSendResetSuccessEmail,
	handleSendVerificationEmail,
} from "./event-handlers/identity-event-handlers"
import { handleSendPaymentSuccessEmail } from "./event-handlers/payment-event-handlers"
...
async function startServer() {
	try {
		...
		await consumeEvent(
			"identity.service",
			"user.reset_password.successful",
			handleSendResetSuccessEmail
		)
		await consumeEvent(
			"order.service",
			"order.updated",
			handleSendPaymentSuccessEmail
		)
		app.listen(PORT, () => {
